...
title_figure = 'Camera Calibration Toolbox - Custom Version';
...
cell_list{3,4} = {'Exit',['disp(''Bye. To run again, type calib_gui.''); close(' num2str(fig_number) '); clearvars my_window;']}; %{'Exit','calib_gui;'};
...
cell_list{5,1} = {'Quickstart','quickstart;'};
cell_list{5,2} = {'Auto Extract corners','my_click_calib;'};
cell_list{5,3} = {'Redo Targeted','redo_prompt;'};
cell_list{5,3} = {'Complete Calib','complete_calib;'};
